<x-app-layout>
    <div class="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
        <h2 class="text-2xl font-bold text-blue-700 mb-6">Registrar Historial Médico</h2>
        ...
        <form method="POST" action="{{ route('historiales.store') }}">
            ...
            <div class="mb-4">
                ...
                <select id="paciente_id" name="paciente_id" required
                    ...
                    <option value="" disabled {{ old('paciente_id', $pacienteId) ? '' : 'selected' }}>-- Seleccione --</option>
                    @foreach ($pacientes as $paciente)
                        <option value="{{ $paciente->id }}"
                            {{ old('paciente_id', $pacienteId) == $paciente->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <select id="doctor_id" name="doctor_id" required
                    class="w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">
                    <option value="" disabled {{ old('doctor_id') ? '' : 'selected' }}>-- Seleccione --</option>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="motivo_consulta" name="motivo_consulta" placeholder="Opcional"
            ...
            <div class="mb-4">
                ...
                <textarea id="diagnostico" name="diagnostico" rows="3" required
                    class="w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">{{ old('diagnostico') }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="tratamiento" name="tratamiento" rows="3" required
                    class="w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">{{ old('tratamiento') }}</textarea>
            </div>
